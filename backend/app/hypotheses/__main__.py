...
`fetch` telecharge les fichiers manquants ou alteres et verifie leurs empreintes. `--record` epingle
un modele qui ne l'est pas encore : le models.json modifie doit etre relu puis commite.
"""
import argparse
import sys
...
def main(argv=None):
    ...
    parser.add_argument('--record', action='store_true', help='epingler un modele non epingle')
