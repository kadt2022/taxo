...
3. **Le diff seulement.** Seuls les blocs modifiés (avec les lignes de contexte du diff) sont transmis,
   jamais les fichiers entiers ni le reste du dépôt. Limites : 20 fichiers, 1 500 lignes, 32 Ko, et jamais plus de la moitié de la fenêtre du modèle (les faits de Taxo gardent leur place). Un
