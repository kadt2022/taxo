...
3. **Le diff seulement.** Seuls les blocs modifiés (avec les lignes de contexte du diff) sont transmis,
   jamais les fichiers entiers ni le reste du dépôt. Limites : 20 fichiers, 1 500 lignes, 32 Ko, et la place que les faits de Taxo laissent dans la fenêtre du modèle : les faits passent d'abord.
   Le code passe avant les tests, qui cèdent les premiers quand la place manque. Un
