...
- trois fins de parcours possibles, et seulement trois :
  1. un fait connu poursuit la chaîne ;
  2. un mécanisme déclaré `NOT_INTERPRETED` arrête la chaîne en le disant ;
  3. l'absence de fait arrête la chaîne en le disant.
